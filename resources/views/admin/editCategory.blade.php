					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" action="{{route('admin.updateCategory',[$category->id])}}" data-parsley-validate class="form-horizontal form-label-left" method="post">
										@csrf
										@method('put')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required" name="cat_name" value="{{$category->cat_name}}" class="form-control ">
											</div>
										</div>
