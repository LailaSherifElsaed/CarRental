					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" action="{{route('admin.updateTestimonial',[$testimonial->id])}}" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
										@csrf
										@method('put')
										...
										<div class="item form-group">
											...
											<br>
											<img src="{{ asset('assets/images/' . $testimonial->image) }}" alt="Testimonial Image" style="width: 200px;">
										</div>
