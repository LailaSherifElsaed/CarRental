					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{ route('updateUser',[$user->id]) }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
										@csrf
										@method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="user_name" required="required" class="form-control" value="{{ $user->user_name }}">
											</div>
										</div>
										<div class="item form-group">
